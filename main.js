...
const caixaPerguntas = document.querySelector(".caixa-peguntas");
...
const perguntas = [
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Ao final da discussão, você precisou criar uma imagem no computador que representasse o que pensa sobre IA. E agora?",
                afirmacao: "afirmação"
            },
            {
